...
export class AuthService {
  ...
  decod = this.decode.asObservable();
  ...
  register(data: Register): Observable<Register> {
    return this.httpClient.post<Register>('https://ecommerce.routemisr.com/api/v1/auth/signup', data)
  }
  login(data: Login): Observable<any> {
    return this.httpClient.post<any>('https://ecommerce.routemisr.com/api/v1/auth/signin', data)
  }
  Logout() {
  ...
  updateUserInformation(data: any): Observable<any> {
    ...
    return this.httpClient.put<any>(`https://ecommerce.routemisr.com/api/v1/users/updateMe/`, data, { headers });
  ...
  changePassword(data: any): Observable<any> {
    ...
    return this.httpClient.put<any>(`https://ecommerce.routemisr.com/api/v1/users/changeMyPassword`, data, { headers });
  }
  ...
  addUserAddrsss(data: any): Observable<any> {
    ...
    return this.httpClient.post<any>(`https://ecommerce.routemisr.com/api/v1/addresses`, data, { headers })
  }
  getUserAddrsss(): Observable<any> {
    ...
    return this.httpClient.get<any>(`https://ecommerce.routemisr.com/api/v1/addresses`, { headers })
  }
  removeUserAddrsss(id: any): Observable<any> {
    ...
    return this.httpClient.delete<any>(`https://ecommerce.routemisr.com/api/v1/addresses/${id}`, { headers })
  }
